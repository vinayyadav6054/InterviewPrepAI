    ...
    <>
      <div className='w-full min-h-full bg-[#fffcef] '>
        <div className='w-[500px] h-[500px] bg-amber-200/20 blur-[65px] absolute top-0 left-0 z-0'> </div>
          ...
          <div className='container mx-auto px-4 pt-6 p-[200px] relative z-10'>
            {/* Header */}
            ...
            <div className='flex flex-col md:flex-row items-center'>
              <div className='w-full md:w-1/2 pr-4 mb-8 md:mb-0'>
                ...
                <h1 className='text-5xl text-black font-medium mb-6 leading-tight'>
                  ...
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-yellow-300 font-semibold">
                    AI-Powered 
                  </span>{" "}
                  Learning
                </h1>
              ...
              <div className='w-full md:w-1/2'>
                <p className='text-[17px] text-gray-900 mr-0 md:mr-20 mb-6'>
                  ...
                  dive deeper into concepts, and organize everthing your way.
